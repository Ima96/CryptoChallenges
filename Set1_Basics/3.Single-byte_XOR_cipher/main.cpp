...
int main(void) {
	...
	// Encrypted message
	string encoded_str = "1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736";
	// Decrypt message
	char key;
	string decrypted_message = decrypt(encoded_str, key);

	cout << "Given encrypted message is: " << encoded_str << endl << endl;
	cout << "The decrypted message is: " << decrypted_message << endl;
	cout << "The key for encryption/decryption is: " << key << endl;
